    ...
    <div className="terms-container">
      <main>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Influence.io.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Influence.io, accessible from{" "}
              <a
                href="https://next-sample-teal.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://next-sample-teal.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          ...
          contact us by email at influence.io@gmail.com
        </p>
      </main>
